...
get_google_drive_service = lambda: None
...
async def build_schedule_export_data(start_date: str, end_date: str, worker_ids: Optional[str] = None):
...
async def export_schedule(
    ...
    export_data = await build_schedule_export_data(start_date, end_date, worker_ids)
